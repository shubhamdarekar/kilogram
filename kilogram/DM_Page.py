...
class DM_Page(tk.Frame):
	def __init__(self,master):
		self.mainDMframe = tk.Frame(master.navbar.midframe, bg = 'pink')
		self.mainDMframe.place(relwidth = 1,relheight = 1)

		self.searchuser_label = tk.Label(self.mainDMframe,bg = "pink",text = "Find User",font = ('Ariel', 15))
		...
		self.searchuser_button = tk.Button(self.mainDMframe,bg = "white",text = "Search User", command = master.presssearchbutton3)
